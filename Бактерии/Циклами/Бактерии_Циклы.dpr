...
Repeat
  ...
  while (SumGreen >= 0) and (SumRed >= 0) and (SumAll >= 0) and (I <= N) do
   Begin
  ...
  // Values output
  if (SumGreen >= 0) and (SumRed >= 0) and (SumAll >= 0)then
    Begin
    ...
    Begin
      ...
      Writeln('');
      Writeln('Последние положительные значения (', (I-1),' такте):');
      Writeln('Количество зеленых: ', SumRed);
      Writeln('Количество красных: ', (SumGreen - SumRed));
